...
const DashboardStudent = () => {
  const subjects = ["ASDII", "PII", "CDI", "MPI", "LFTA", "PP", "LE", "EWB", "PV", "PLA"];
  ...
  const posts = [
    {
      ...
      comment: "Da sigur! Daca te uiti la fisiere pe classroom este un document cu teoria de la liste cu tot cu exemple.",
    },
    {
      ...
      comment: "Trebuie sa incadrezi termenul respectiv intre alti doi termeni dupa care treci la limita, iar limita din mijloc da tinde si ea la celelalte doua.",
    },
    {
      ...
      time: "12:10",
      helper: "Tudor Nagy",
      comment: "Salut! Trebuie sa ai grija la cele 3 reguli. Prima data vezi daca se poate aplica regula literalului pur sau cea a clauzei cu un sigur literal. Daca nu aplici rezolutia.",
    },
    {
